  ...
  return (
    <AuthLayout title="Welcome back" subtitle="Sign in to hold and book seats in real time.">
      ...
      <div className="mt-6 rounded-xl border border-white/5 bg-white/[0.03] p-3.5">
        <div className="mb-2 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500">Try the demo</div>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 rounded-xl border border-violet-400/30 bg-violet-600/20 px-3 py-2 text-xs font-medium text-violet-200 transition hover:bg-violet-600/35"
          >
            👑 Admin account
          </button>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        New here? <Link to="/register" className="font-medium text-violet-300 hover:underline">Create an account</Link>
      </p>
    </AuthLayout>
  );
}
